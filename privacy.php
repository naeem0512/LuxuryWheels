...
<body>
    ...
    <!-- Page Header -->
    <?php echo '<div class="about_info about_content"><h2>Privacy Policy</h2></div>';
   ...
   // Define the page type
    ...
    if ($result) {
        $privacyText = nl2br($result['detail']); // Add line breaks
        echo '<div class="a_info about_page container">'. $privacyText . '</div>';
